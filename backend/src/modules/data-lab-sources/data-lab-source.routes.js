...
const controller = require("./data-lab-source.controller");
const { createDataSourceSchema, updateDataSourceSchema } = require("../data-sources/data-source.schema");

const router = express.Router();

router.use(authMiddleware, activationMiddleware);
router.get("/", asyncHandler(controller.listDataSources));
router.get("/:id/scenes", asyncHandler(controller.listReferencedScenes));
