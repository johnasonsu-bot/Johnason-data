...
// backend/src/modules/reporting/reporting-ai-config.controller.js
var require_reporting_ai_config_controller = __commonJS({
  "backend/src/modules/reporting/reporting-ai-config.controller.js"(exports2, module2) {
    var { sendSuccess } = require_response();
    var service = require_reporting_ai_config_service();
...
// packages/data-platform-module-reporting/src/.runtime-entry.js
var controller0 = require_reporting_ai_config_controller();
var controller1 = require_reporting_controller();
var { Writable } = require("node:stream");
var handlers = {
  "GET /api/v1/reporting-ai-configs": controller0["listConfigs"],
  "PUT /api/v1/reporting-ai-configs/:id": controller0["updateConfig"],
  "GET /api/v1/reporting/runtime/dashboards/:id/theme-templates": controller1["listRuntimeReportThemeTemplates"],
  "POST /api/v1/reporting/runtime/dashboards/:id/preview-chart": controller1["previewRuntimeDashboardChart"],
  "GET /api/v1/reporting/overview": controller1["getOverview"],
  "POST /api/v1/reporting/ai/chart/analysis-suggestions": controller1["suggestAiChartAnalysis"],
  "POST /api/v1/reporting/ai/chart/sql-plan": controller1["planAiChartSql"],
  "POST /api/v1/reporting/ai/chart/sql-revise": controller1["reviseAiChartSql"],
  "POST /api/v1/reporting/ai/chart/query": controller1["runAiChartQuery"],
  "POST /api/v1/reporting/ai/chart/recommend": controller1["recommendAiChart"],
  "POST /api/v1/reporting/ai/chart/field-map": controller1["allocateAiChartFieldMap"],
  "GET /api/v1/reporting/data-sources": controller1["listReportDataSources"],
  "POST /api/v1/reporting/data-sources": controller1["createReportDataSource"],
  "PUT /api/v1/reporting/data-sources/:id": controller1["updateReportDataSource"],
  "DELETE /api/v1/reporting/data-sources/:id": controller1["deleteReportDataSource"],
  "POST /api/v1/reporting/data-sources/test-connection": controller1["testReportDataSourceConnection"],
  "GET /api/v1/reporting/data-sources/:id/tables": controller1["listReportDataSourceTables"],
  "GET /api/v1/reporting/data-sources/:id/tables/:tableName/columns": controller1["listReportDataSourceColumns"],
  "GET /api/v1/reporting/data-sources/:id/tables/:tableName/sample": controller1["sampleReportDataSourceRows"],
  "GET /api/v1/reporting/dataset-folders": controller1["listReportDatasetFolders"],
  "POST /api/v1/reporting/dataset-folders": controller1["createReportDatasetFolder"],
  "PUT /api/v1/reporting/dataset-folders/:id": controller1["updateReportDatasetFolder"],
  "DELETE /api/v1/reporting/dataset-folders/:id": controller1["deleteReportDatasetFolder"],
  "GET /api/v1/reporting/datasets": controller1["listReportDatasets"],
  "POST /api/v1/reporting/datasets/preview": controller1["previewReportDataset"],
  "POST /api/v1/reporting/datasets": controller1["createReportDataset"],
  "PUT /api/v1/reporting/datasets/:id": controller1["updateReportDataset"],
  "DELETE /api/v1/reporting/datasets/:id": controller1["deleteReportDataset"],
  "GET /api/v1/reporting/chart-assets": controller1["listReportChartAssets"],
  "POST /api/v1/reporting/chart-assets": controller1["createReportChartAsset"],
  "PUT /api/v1/reporting/chart-assets/:id": controller1["updateReportChartAsset"],
  "DELETE /api/v1/reporting/chart-assets/:id": controller1["deleteReportChartAsset"],
  "GET /api/v1/reporting/theme-templates": controller1["listReportThemeTemplates"],
  "POST /api/v1/reporting/theme-templates": controller1["createReportThemeTemplate"],
  "PUT /api/v1/reporting/theme-templates/:id": controller1["updateReportThemeTemplate"],
  "DELETE /api/v1/reporting/theme-templates/:id": controller1["deleteReportThemeTemplate"],
  "GET /api/v1/reporting/dashboards": controller1["listReportDashboards"],
  "GET /api/v1/reporting/dashboards/:id": controller1["getReportDashboard"],
  "POST /api/v1/reporting/dashboards/:id/publish": controller1["publishReportDashboard"],
  "POST /api/v1/reporting/dashboards/preview-chart": controller1["previewDashboardChart"],
  "POST /api/v1/reporting/dashboards": controller1["createReportDashboard"],
  "PUT /api/v1/reporting/dashboards/:id": controller1["updateReportDashboard"],
  "DELETE /api/v1/reporting/dashboards/:id": controller1["deleteReportDashboard"]
};
