...
// backend/src/modules/dev-ai-configs/dev-ai-config.controller.js
var require_dev_ai_config_controller = __commonJS({
  "backend/src/modules/dev-ai-configs/dev-ai-config.controller.js"(exports2, module2) {
    var { sendSuccess } = require_response();
    var service = require_dev_ai_config_service();
...
// packages/data-platform-module-dev-ai-configs/src/.runtime-entry.js
var controller0 = require_dev_ai_config_controller();
var { Writable } = require("node:stream");
var handlers = {
  "GET /api/v1/dev-ai-configs": controller0["listConfigs"],
  "PUT /api/v1/dev-ai-configs/:id": controller0["updateConfig"]
};
