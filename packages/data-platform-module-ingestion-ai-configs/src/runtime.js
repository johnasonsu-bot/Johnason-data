...
// backend/src/modules/ingestion-ai-configs/ingestion-ai-config.controller.js
var require_ingestion_ai_config_controller = __commonJS({
  "backend/src/modules/ingestion-ai-configs/ingestion-ai-config.controller.js"(exports2, module2) {
    var { sendSuccess } = require_response();
    var service = require_ingestion_ai_config_service();
...
// packages/data-platform-module-ingestion-ai-configs/src/.runtime-entry.js
var controller0 = require_ingestion_ai_config_controller();
var { Writable } = require("node:stream");
var handlers = {
  "GET /api/v1/ingestion-ai-configs": controller0["listConfigs"],
  "PUT /api/v1/ingestion-ai-configs/:id": controller0["updateConfig"]
};
